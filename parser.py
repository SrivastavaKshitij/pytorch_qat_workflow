...
def parse_args():
    ...
    parser.add_argument('--parallel', default=False,help='Whether to use data parallelism')
    ...
    parser.add_argument('--qm','--quantize_model',action='store_true', help = "quantize entire model ? ")
